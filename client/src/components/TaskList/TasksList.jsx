    ...
    <Box sx={sxStyles.root}>
      ...
      <Box sx={sxStyles.header}>
        <FormControl>
          ...
          >
            {Object.keys(priorityEnums).map((priority) => (
              <MenuItem value={priorityEnums[priority]}>
      ...
      <Box>
        {tasks.map((task, index) => {
          console.log(selectedPriority === priorityEnums.ALL);
          {
            return selectedPriority === priorityEnums.ALL ||
              ...
              <Box key={index} sx={sxStyles.item}>
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <Box>
                    ...
                    <IconButton>
                      <Delete onClick={() => handleDeleteButtonClick(task)} />
                    </IconButton>
                  </Box>
                </Box>
              </Box>
